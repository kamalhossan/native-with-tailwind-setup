...
export default function LoginScreen({navigation}) {
  return (
    <View className='flex-1 justify-center items-center bg-[#f7f7f7]'>
      ...
      <Text className='text-center mt-3 text-2xl font-light text-orange-600 font-bold'>
        Login
      </Text>
      ...
      <View className='mt-5 mx-5'>
        ...
        <TouchableOpacity className='bg-orange-300 p-3 mt-4'>
          <Text className='text-center text-base text-white font-bold'>Login</Text>
        </TouchableOpacity>
        ...
        <View className='mt-4'>
          <TouchableOpacity className='flex flex-row items-center justify-center p-2 bg-orange-300'>
            <Text className='text-white mx-2 text-sm font-bold'>Sign In With Google</Text>
          </TouchableOpacity>
        </View>
        <View className='mt-6 flex-row justify-center'>
          <Text className='w-[240]'>New to App?</Text>
          <TouchableOpacity 
